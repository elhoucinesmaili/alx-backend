#!/usr/bin/env python3
"""
Class with methods to paginate CSV data of popular baby names.
"""
...
class Server:
    ...
    def get_hyper(self, page: int = 1, page_size: int = 10) -> dict:
        """
        Return pagination information along with the page data.
        ...
        Returns:
            dict: A dictionary with pagination details and page data.
        """
